...
import { hasFullTeamAccess, getTeamCode, isMakerAccess } from '../utils/access';
import {
    PageShell,
    SectionCard,
    PrimaryButton,
...
export default function TeamSelector({ setPage, setResultData }) {
    const storedCode = getTeamCode();
